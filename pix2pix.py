...
def main():
    ...
    for epoch in range(args.num_epochs):
        ...
        model_save_name = 'generator-%d.pkl'%(epoch+1)
        drive_path= F"/content/gdrive/My Drive/pix2pix/models/{model_save_name}"
        torch.save(generator.state_dict(), drive_path)
        
        # model_save_name = 'generator-13.pkl'
        # path = F"/content/gdrive/My Drive/pi2pix/models/{model_save_name}"
